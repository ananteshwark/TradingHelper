...
All seven build steps and a safeguards layer are implemented and tested (404 tests; CI runs lint, the look-ahead gate and the full suite against PostgreSQL 16).
